...
function getDivisonsAbs(selectionType,selectionName,selectionId){
	...
	if(selectionType=='allcircles'){
	 ...
	 $('#cirName').val('');
	  ...
	  $.ajax({
		 type : 'POST',
		 url : 'wrongfulDisconnectionOfServiceReport',
		 data : params,
		 async : true,
		 cache : false,
          ...
          <div class="col-12">
           <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Wrongful disconnection of service connection</h3>
              ...
              <div class="card-body table-responsive p-0">
                 <table class="table table-hover">
                  <thead>
                    ...
                    <th rowspan="2" style="vertical-align: middle;">${thName}</th>
       				<th rowspan="2" style="vertical-align: middle;">No. of Complaints</th>
                    </tr>             
                  </thead>
                  <tbody>
                  <c:choose>
                ...
                <c:set var="fld10Tot" value="0"/> --%>
                  ...
                  <c:forEach items="${list}" var="list" varStatus="indexing"> 
                    ...
                    <td align="left"><a style="cursor: pointer;color: blue;" onclick="getDivisonsAbs('${selectionType}','${list.fld2}','${list.fld3}')">${list.fld2}</a></td>
