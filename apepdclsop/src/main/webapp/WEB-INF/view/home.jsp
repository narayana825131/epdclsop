              ...
              <div class="card-body table-responsive p-0">
                 <table class="table table-hover">
                  <thead>
                   ...
                   <tr align="center">
                    <th style="vertical-align: middle;">No. of Complaints</th>
                    <th style="vertical-align: middle;">Minimum Duration (Hrs)</th>
                    <th style="vertical-align: middle;">Maximum Duration (Hrs)</th>
                    <th style="vertical-align: middle;">Average Duration (Hrs)</th>
                    <th style="vertical-align: middle;">Complaints Resolved within Service Level (%)</th>
                    <th style="vertical-align: middle;">No. of Complaints</th>
                    <th style="vertical-align: middle;">Minimum Duration (Hrs)</th>
                    <th style="vertical-align: middle;">Maximum Duration (Hrs)</th>
                    <th style="vertical-align: middle;">Average Duration (Hrs)</th>
