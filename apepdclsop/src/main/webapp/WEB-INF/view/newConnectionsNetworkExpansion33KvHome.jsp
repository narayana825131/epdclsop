...
function getDivisonsAbs(selectionType,selectionName,selectionId){
	...
	if(selectionType=='allcircles'){
	 ...
	 $('#cirName').val('');
	  ...
	  $.ajax({
		 type : 'POST',
		 url : 'newConnectionsNetworkExpansion33KVReport',
		 data : params,
		 async : true,
		 cache : false,
          ...
          <div class="col-12">
           <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Processing of application for new connections / Additional loads - Network expansion - 33KV</h3>
