...
function getDivisonsAbs(selectionType,selectionName,selectionId){
	...
	if(selectionType=='allcircles'){
	 ...
	 $('#cirName').val('');
	  ...
	  $.ajax({
		 type : 'POST',
		 url : 'resolutionBillingComplaintsReport',
		 data : params,
		 async : true,
		 cache : false,
          ...
          <div class="col-12">
           <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Resolution of billing complaints - no addl info required</h3>
			  ...
			  <div class="row">
                  <div class="input-group input-group-sm col-12" style="margin:5px;">
                   ...
                   <h4 class="card-title">Financial Year : </h4>
					...
					<c:forEach begin="0" end="${tempFinYear[1]-2022}" varStatus="loop">
              ...
              <div class="card-body table-responsive p-0">
                ...
                <c:set var="fld10Tot" value="0"/> --%>
                  ...
                  <c:forEach items="${list}" var="list" varStatus="indexing"> 
                    ...
                    <td align="left"><a style="cursor: pointer;color: blue;" onclick="getDivisonsAbs('${selectionType}','${list.fld6}','${list.fld7}')">${list.fld6}</a> </td>
