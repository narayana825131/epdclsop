...
function getDivisonsAbs(selectionType,selectionName,selectionId){
	...
	if(selectionType=='allcircles'){
	 ...
	 $('#cirName').val('');
	  ...
	  $.ajax({
		 type : 'POST',
		 url : 'scheduledOutagesRestorationsupplyReport',
		 data : params,
		 async : true,
		 cache : false,
          ...
          <div class="col-12">
           <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Scheduled Outages - Restoration of supply by 6pm</h3>
              ...
              <div class="card-body table-responsive p-0">
                 <table class="table table-hover">
                  <thead>
                   <tr align="center">
                    ...
                    <th>Number of times when supply was restored after 6pm</th>
                    <th>Number of times when supply was restored before 6pm</th>
                    <th>Percentage of Restorations before 6pm</th>
                  </tr>
                  </thead>
                  <tbody>
                  <c:choose>
                ...
                <c:set var="fld10Tot" value="0"/> --%>
                  ...
                  <c:forEach items="${list}" var="list" varStatus="indexing"> 
                    ...
                    <td align="left"><a style="cursor: pointer;color: blue;" onclick="getDivisonsAbs('${selectionType}','${list.fld5}','${list.fld6}')">${list.fld5}</a> </td>
...
var responseList='${responseList}';
  $(function () {
      ...
      datasets: [
		...
		{
          label               : 'Percentage of Restorations before 6pm',
          backgroundColor     : 'rgba(0, 107, 179, 1)',
          borderColor         : 'rgba(0, 107, 179, 1)',
          pointRadius         : false,
